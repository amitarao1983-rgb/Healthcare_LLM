# Lull - Live Voice Agent (Standalone)

This folder is a standalone copy of the Lull app. It does not depend on the
Healthcare LLM Streamlit app and does not require a Gemini API key.
...
This repo includes a web deployment at `streamlit_app.py`.
